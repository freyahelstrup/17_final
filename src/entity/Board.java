...
/**/		fields[0] = new Street(1, Color.white, 60, 2);	//Start
		fields[1] = new Street(2, Color.cyan, 60, 2);		//Rødovrevej
/**/		fields[2] = new Street(3, Color.white, 60, 2);	//Chance
		fields[3] = new Street(4, Color.cyan, 60, 4);		//Hvidovre
...
/**/		fields[22] = new Street(23, Color.white, 60, 2);	//Chance
		...
		fields[26] = new Street(27, Color.magenta, 260, 22);	//Bredgade
		fields[27] = new Street(28, Color.magenta, 260, 22);	//Kongens Nytorv
		fields[28] = new Brewery(29, Color.white, 150);	//Carlsberg
		fields[29] = new Street(30, Color.magenta, 280, 22);	//Østergade
/**/		fields[30] = new Street(31, Color.white, 60, 2);	//Politi (GoToPrison)
		fields[31] = new Street(32, Color.yellow, 300, 26);	//Amagertorv
		fields[32] = new Street(33, Color.yellow, 300, 26);	//Vimmelskaftet
/**/		fields[33] = new Street(34, Color.white, 60, 2);	//Chance
		fields[34] = new Street(35, Color.yellow, 320, 28);	//Nygade
		fields[35] = new Fleet(36, Color.white, 200); 	//D/S Bornholm
/**/		fields[36] = new Street(37, Color.white, 60, 2);	//Chance
		fields[37] = new Street(38, Color.orange, 350, 35);	//Frederiksberggade
		fields[38] = new Tax(39, Color.white, 0, 100); 	//Ekstraordinær statsskat
		fields[39] = new Street(40, Color.orange, 400, 50);	//Rådhuspladsen
