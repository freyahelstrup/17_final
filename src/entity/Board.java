...
/**/		fields[2] = new Chance(3, Color.white);	//Chance
		...
		fields[6] = new Street(7, Color.pink, 100, new int[]{6,30,90,270,400,550},50);		//Roskildevej
...
/*MISSING*/		fields[10] = new Chance(11, Color.white);	//Fængsel
		...
		fields[14] = new Street(15, Color.green, 160, new int[]{12,60,180,500,700,900},100);	//Gl. Kongevej
		fields[15] = new Fleet(16, Color.white, 200);	//D.F.D.S
		fields[16] = new Street(17, Color.gray, 180, new int[]{14,70,200,550,750,950},100);	//Bernstorffsvej
...
/**/		fields[22] = new Chance(23, Color.white);	//Chance
		...
		fields[24] = new Street(25, Color.red, 240, new int[]{20,100,300,750,925,1100},150);		//Grønningen
		fields[25] = new Fleet(26, Color.white, 200); 	//Ø.K.
		fields[26] = new Street(27, Color.magenta, 260, new int[]{22,110,330,800,975,1150},150);	//Bredgade
...
/**/		fields[33] = new Chance(34, Color.white);	//Chance
		fields[34] = new Street(35, Color.yellow, 320, new int[]{28,150,450,1000,1200,1400},200);	//Nygade
		fields[35] = new Fleet(36, Color.white, 200); 	//D/S Bornholm
/**/		fields[36] = new Chance(37, Color.white);	//Chance
		fields[37] = new Street(38, Color.orange, 350, new int[]{35,175,500,1100,1300,1500},200);	//Frederiksberggade
		fields[38] = new Tax(39, Color.white, 0, 100); 	//Ekstraordinær statsskat
		fields[39] = new Street(40, Color.orange, 400, new int[]{50,200,600,1400,1700,2000},200);	//Rådhuspladsen
